...
if(isset($_GET['success'])) {
	echo '<script language="javascript">alert("Utilizator Autentificat cu Succes!!!")</script>';
}
?>
						...
						<li class="active"><a href="view.php">Gestionare Fise</a></li> 
							...
							<li>
									<div class="form-group">
										<input type="submit" value="Cauta" id="searchbutton" name="submit">
									</div>
								</form>
							</li>
					</ul>
		...
		<tbody>
			...
			while ($row = mysqli_fetch_object ($sql))
			{
				echo  "<tr>
						...
						<td><a href='edit.php?ide=$row->id'>Editeaza</a><br>
							<a href='delete.php?idd=$row->id'>Sterge</a> 
							<a href='print.php?idp=$row->id'>Listeaza</a>
						</td>
						<td><a href='upload.php?idu=$row->id'>Incarca</a> 
							<a href='viewdoc.php?idv=$row->id'>Vizulizeaza</a> 
						</td>
					  </tr>";
			}
			?>
